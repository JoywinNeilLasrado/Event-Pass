...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/joywin/Event-Pass/public/storage' => 'string',
            ...
            'services.cashfree.app_id' => 'string',
            'services.cashfree.secret_key' => 'string',
            'services.cashfree.env' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/joywin/Event-Pass/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'services.ses.secret','services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.cashfree.app_id',
'services.cashfree.secret_key','services.cashfree.env','session.driver','session.lifetime','session.expire_on_close',
...
'signed','throttle','verified','event.owner','admin',
'organizer',);
        registerArgumentsSet('routes', 'cashfree.webhook','dashboard','scan',
'team.store','team.destroy','events.index','events.create','events.store',
'events.show','promo_codes.validate','events.edit','events.update','events.destroy',
'events.attendees','events.message_attendees','events.export','events.retry_publish_payment','promo_codes.index',
'promo_codes.store','promo_codes.destroy','profile.edit','profile.update','profile.destroy',
'upgrade.index','upgrade.basic','upgrade.pro','upgrade.cancel','bookings.index',
'bookings.store','bookings.destroy','waitlists.store','bookings.ticket','payment.success',
'payment.cancel','organizers.show','cashfree.connect','cashfree.disconnect','tickets.verify',
'tickets.checkin','api.events','kyc.setup','kyc.submit',
...
'admin.dashboard','admin.users.index','admin.users.toggle-admin','admin.users.destroy','admin.events.index',
'admin.events.destroy','admin.events.restore','admin.events.force-destroy','admin.categories.index','admin.categories.store',
'admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.tags.index','admin.tags.store',
'admin.tags.destroy','admin.bookings.index','admin.bookings.destroy','admin.kyc.index','admin.kyc.approve',
'admin.kyc.reject','admin.financials.index','admin.settings.index','admin.settings.update','admin.audit-logs.index',
'admin.system.index','admin.system.retry','admin.system.delete','admin.system.flush','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'admin.audit_logs.index','admin.bookings.index','admin.categories.edit','admin.categories.index','admin.dashboard',
'admin.events.index','admin.financials.index','admin.kyc.index','admin.settings.index','admin.system_health.index',
'admin.tags.index','admin.users.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','bookings.cashfree_checkout','bookings.index',
'bookings.ticket','bookings.verify','components.admin.layout','components.application-logo','components.auth-session-status',
'components.category-carousel','components.danger-button','components.dropdown','components.dropdown-link','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','dashboard','emails.attendee_broadcast','emails.events.reminder',
'emails.ticket-booked','emails.waitlist-available','events.attendees','events.create','events.edit',
'events.index','events.partials.event-card','events.show','kyc.setup','layouts.app',
'layouts.guest','layouts.navigation','organizers.show','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','promo_codes.index','scan','upgrade.index',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','STRIPE_SECRET','STRIPE_KEY','STRIPE_WEBHOOK_SECRET',
